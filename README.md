...
| [![arduino_nano_fullbridge_cc_driver](https://img.shields.io/badge/Top_Project-🌟-blue?style=plastic) **arduino_nano_fullbridge_cc_driver**](https://github.com/gkeiel/pcb_design_kicad/tree/main/arduino_nano_fullbridge_cc_driver) | Design of a **full-bridge CC driver and sensor for Arduino Nano (carrier board)**. Includes **schematic**, **PCB**, **BOM** and **Gerber files**. | KiCad |
| [![arduino_nano_fullbridge_cc_driver](https://img.shields.io/badge/Top_Project-🌟-blue?style=plastic) **arduino_nano_low_side_cc_driver**](https://github.com/gkeiel/pcb_design_kicad/tree/main/arduino_nano_low_side_cc_driver) | Design of a **two low-side CC driver and sensor for Arduino Nano (carrier board)**. Includes **schematic**, **PCB**, **BOM** and **Gerber files**. | KiCad |
